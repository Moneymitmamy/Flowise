...
export interface ITicketSetupWebPartProps extends IAppConfig {}

export default class TicketSetupWebPart extends BaseClientSideWebPart<ITicketSetupWebPartProps> {
  public render(): void {
    const element = React.createElement(TicketSetup, {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Ticket-Setup Konfiguration' },
          groups: [
            {
              groupName: 'Listen',
              groupFields: [
