...
export interface ITicketDetailWebPartProps extends IAppConfig {}

export default class TicketDetailWebPart extends BaseClientSideWebPart<ITicketDetailWebPartProps> {
  public render(): void {
    const element = React.createElement(TicketDetail, {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Ticket-Detail Konfiguration' },
          groups: [
            {
              groupName: 'Listen',
              groupFields: [
